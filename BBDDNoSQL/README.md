...
```
java -Dspring.profiles.active=production -jar ./target/BBDDNoSQL-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=com.example/b-b-d-d-no-s-q-l
```
